    ...
    <div id="about-page">
            ...
            <div class="container py-5">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        ...
                        <a href="{{ route("home.contact") }}" class="btn btn-primary mt-3">Get In Touch</a>
                    </div>
        ...
        <section class="py-5 bg-light">
            <div class="container py-5">
                ...
                <div class="row mt-5">
                    <x-value icons="fas fa-paint-brush" headings="Creativity Firs" paragraphs="We believe in putting artists and their creative vision at the center of everything we do."/>


                    <x-value icons="fas fa-handshake" headings="Community Focus" paragraphs="We're building more than a platform - we're building a supportive creative community."/>


                    <x-value icons="fas fa-lock" headings="CArtist Ownership" paragraphs="Artists retain full rights to their work. We're just here to help share it with the world."/>
